...
_SOCKETCONFIG_TCPFASTOPENSTATE = _descriptor.EnumDescriptor(
  ...
  full_name='xray.transport.internet.SocketConfig.TCPFastOpenState',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
